...
public class PlotGlycolysisFactory extends AbstractTaskFactory {
	...
	public PlotGlycolysisFactory(final CyNetworkManager netMgr, final CyNetworkNaming namingUtil, 
