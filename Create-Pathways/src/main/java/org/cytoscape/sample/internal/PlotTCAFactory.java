...
public class PlotTCAFactory extends AbstractTaskFactory {
	...
	public PlotTCAFactory(final CyNetworkManager netMgr, final CyNetworkNaming namingUtil, 
	...
	public TaskIterator createTaskIterator(){
		return new TaskIterator(new PlotTCA(netMgr, namingUtil, cnf, eventHelper,
